...
-->
        ...
        <li>
            <div class="timeline-badge internship">Fev 2010</i></div>

            <div class="timeline-panel">
                <div class="timeline-heading">
                    <h4 class="timeline-title">Assistant Category Manager / United Biscuits</h4>
                    <p><small class="text-muted"><i class="glyphicon glyphicon-map-marker"></i> Paris, France</small></p>
        ...
        <li class="timeline-inverted">
            <div class="timeline-badge internship">June 2008</i></div>
            <div class="timeline-panel">
                <div class="timeline-heading">
                    <h4 class="timeline-title">Marketing assistant / Vignobles Germain</h4>
        ...
        <li>
            <div class="timeline-badge school">May 2007</i></div>
            <div class="timeline-panel">
                <div class="timeline-heading">
                    <h4 class="timeline-title">Graduation in BTS Commerce International</h4>
                    <p><small class="text-muted"><i class="glyphicon glyphicon-map-marker"></i> Bordeaux, France</small></p>
                </div>
                <div class="timeline-body">
                    <p>Mussum ipsum cacilds, vidis litro abertis. Consetis adipiscings elitis. Pra lá , depois divoltis porris, paradis. Paisis, filhis, espiritis santis. Mé faiz elementum girarzis, nisi eros vermeio, in elementis mé pra quem é amistosis quis leo. Manduma pindureta quium dia nois paga. Sapien in monti palavris qui num significa nadis i pareci latim. Interessantiss quisso pudia ce receita de bolis, mais bolis eu num gostis.</p>
        ...
        <li class="timeline-inverted">
            <div class="timeline-badge job">May 2004</i></div>
            <div class="timeline-panel">
                <div class="timeline-heading">
                    <h4 class="timeline-title">Entrepreneur / Terres & Caractères</h4>
                    <p><small class="text-muted"><i class="glyphicon glyphicon-map-marker"></i> Bordeaux, France</small></p>
                </div>
                <div class="timeline-body">
                    <p>Mussum ipsum cacilds, vidis litro abertis. Consetis adipiscings elitis. Pra lá , depois divoltis porris, paradis. Paisis, filhis, espiritis santis. Mé faiz elementum girarzis, nisi eros vermeio, in elementis mé pra quem é amistosis quis leo. Manduma pindureta quium dia nois paga. Sapien in monti palavris qui num significa nadis i pareci latim. Interessantiss quisso pudia ce receita de bolis, mais bolis eu num gostis.</p>
